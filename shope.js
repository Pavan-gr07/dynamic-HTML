...
var clothConatiner = document.getElementById('clothsConatiner');
var AccessoriesConatiner = document.getElementById('AccessoriesConatiner');
...
for(let i=0;i<productList.length;i++)
{
  ...
  divDetails.append(h3);
  divDetails.append(h4);
  divDetails.append(h5);

  cardContainer.append(divimg);
  cardContainer.append(divDetails);

  clothConatiner.append(cardContainer);

}else{
  
    var cardContainerAcc = document.createElement("div");
    cardContainerAcc.className = "card";
  ...
  cardContainerAcc.append(divimg);
  cardContainerAcc.append(divDetails);
 
  AccessoriesConatiner.append(cardContainerAcc);
}
